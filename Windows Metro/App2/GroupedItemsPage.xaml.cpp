...
void GroupedItemsPage::LoadState(Object^ sender, Common::LoadStateEventArgs^ e)
{
	...
	// TODO: Create an appropriate data model for your problem domain to replace the shop data
	Data::ShopDataSource::GetGroups()
	.then([this](IIterable<Data::ShopDataGroup^>^ shopDataGroups)
	{
		DefaultViewModel->Insert("Groups", shopDataGroups);
...
void GroupedItemsPage::Header_Click(Object^ sender, RoutedEventArgs^ e)
{
	...
	Frame->Navigate(TypeName(GroupDetailPage::typeid), safe_cast<Data::ShopDataGroup^>(group)->UniqueId);
}
...
void GroupedItemsPage::ItemView_ItemClick(Object^ sender, ItemClickEventArgs^ e)
{
	...
	// Navigate to the appropriate destination page, configuring the new page
	// by passing required information as a navigation parameter
	auto itemId = safe_cast<Data::ShopDataItem^>(e->ClickedItem)->UniqueId;
...
void App2::GroupedItemsPage::itemGridView_SelectionChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e)
{
