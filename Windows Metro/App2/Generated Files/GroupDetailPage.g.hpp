...
void ::App2::GroupDetailPage::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::App2::GroupDetailPage::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::ListViewBase^>(target))->ItemClick +=
            ref new ::Windows::UI::Xaml::Controls::ItemClickEventHandler(this, (void (::App2::GroupDetailPage::*)(Platform::Object^, Windows::UI::Xaml::Controls::ItemClickEventArgs^))&GroupDetailPage::ItemView_ItemClick);
        break;
    }
